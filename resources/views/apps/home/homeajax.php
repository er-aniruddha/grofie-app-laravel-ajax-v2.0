...
<div class="container-fluid">
  <div class="row header">
    ...
    <ul class="header-info">
      ...
      <li class="logo">
        <a href="{{ url('/apps/home')}}" ><img src="{{ asset ('public/apps/img/logo-footer.png')}}" alt="Logo"/></a>
      </li>
      <li class="cart-btn">
      @if($i>0)
                  ...
                  '<div class="product ">'
                     +'<a href="single.html">'
                        +'<div class="product-header">'                           
                           +'<img class="img-fluid" src="https://grofie.in/'+data.topsevers[count].product_image_main+'" alt="">'                           
                        +'</div>'
